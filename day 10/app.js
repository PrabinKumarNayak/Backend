...
app.get("/findid/:id", (req, res) => {
  ...
  const result = product.find(item => item.id === parseInt(req.params.id));
  if (result) {
    res.json({
...
app.get("/findtitle/:title", (req, res) => {
  console.log(req.params.title);
  const result = product.find(item => item.title === req.params.title);
  if (result) {
    res.json({
      message: "Record found",
      productdetails: result
...
app.get("/findtags/:tags", (req, res) => {
  console.log(req.params.tags);
  const result = product.find(item => item.tags.includes(req.params.tags));
  if (result) {
    res.json({
      message: "Record found",
      productdetails: result
...
app.get("/findDimensionsWidth/:width", (req, res) => {
  console.log(req.params.dimensions.width);
  const result = product.find(item => item.dimensions.width === parseFloat(req.params.dimensions.width));
  if (result) {
    res.json({
      message: "Record found",
      productdetails: result
